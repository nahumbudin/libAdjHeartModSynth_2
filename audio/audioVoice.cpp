...
//func_ptr_void_int_bool_t free_voice_callback = NULL;
...
*/	
int AudioVoiceFloat::get_sample_rate() { return sample_rate; }
...
*   @return buffer size
*/	
int AudioVoiceFloat::get_audio_block_size() {	return audio_block_size; }
...
{ 
	...
	if (dsp_voice)
	{
		dsp_voice->set_voice_not_waits_for_not_active();
	}
...
*/
bool AudioVoiceFloat::is_voice_wait_for_not_active() { return wait_for_not_active; }
...
void AudioVoiceFloat::update()
{
	...
	for (i = 0; i < audio_block_size; i++) 
	{
		...
		block_out1->data[i] = dsp_voice->get_next_output_value_ch1() * magnitude;
		block_out2->data[i] = dsp_voice->get_next_output_value_ch2() * magnitude; 
	}
