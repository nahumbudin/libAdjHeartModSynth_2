...
*					
*	@History	31-Oct-2019	1.0 (dspWaveformLUT) (revised version from old libAdjHeartRaspiFlSynthMultiCore_3_1)
*
...
*	@return WTAB length
*/
int DSP_WaveformTab::get_wtab_length() { return wtab_length; }
...
*/
float *DSP_WaveformTab::get_wtab_ptr() { return &waveform_tab[0]; }
