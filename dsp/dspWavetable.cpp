...
*	@return none
*/
DSP_Wavetable::DSP_Wavetable(int iD, Wavetable *table)
{
	id = iD;
...
/**
*	@brief	Randomaly select and set pointers positions
*	@param	none
*	@return void
*/
...
*/
float *DSP_Wavetable::get_wavetable() { 	return wavetable->samples; } 
...
*/
int DSP_Wavetable::get_wavetable_size() { return wavetable->size; }
...
*/
int DSP_Wavetable::get_id() { return id; }
...
*/
int DSP_Wavetable::get_freq_detune_oct() { return detune_octave; }
...
*/
int DSP_Wavetable::get_freq_detune_semitones() { return detune_semitones; }
...
*/
int DSP_Wavetable::get_freq_detune_cents_set_value() { return detune_cents_set_value; }
...
*/
float DSP_Wavetable::get_freq_detune_cents() { return detune_cents; }
...
*/
float DSP_Wavetable::get_magnitde() { return magnitude; }
...
*	@return MSO send level to channel 1 0.0-1.0
*/
float DSP_Wavetable::get_send_level_1() { return send_level_1; }
...
*/
float DSP_Wavetable::get_send_level_2() { return send_level_2; }
