...
/**
*	@brief	Set channel 1 pan -1.0 - +1.0
*	@param pn 0.0-1.0
*	@return void
*/
...
/**
*	@brief	Set channel 1 pan 0-100 (50 - mid)
*	@param gn 0.0-100
*	@return void
*/
...
/**
*	@brief	Set channel 2 pan -1.0 - +1.0
*	@param pn 0.0-1.0
*	@return void
*/
...
/**
*	@brief	Set channel 1 pan 0-100 (mid 50)
*	@param pn 000-100
*	@return void
*/
...
*/
float DSP_Amp::get_ch1_gain() { return ch1_gain; }
...
*/
float DSP_Amp::get_ch1_pan() { return ch1_pan; }
...
*	@return channel 1 gain 0.0-1.0
*/
float DSP_Amp::get_ch2_gain() { return ch2_gain; }
...
*	@return channel 1 pan -1.0 - +1.0
*/
float DSP_Amp::get_ch2_pan() { return ch2_pan; }
...
*	@return none
*/
void DSP_Amp::enable_fixed_levels() { fixed_levels = true; }
...
*	@return none
*/
void DSP_Amp::disable_fixed_levels() { fixed_levels = false; }
...
*/
bool DSP_Amp::levels_are_fixed() { return fixed_levels; }
