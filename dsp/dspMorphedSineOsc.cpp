...
{
	if (base_waveform_tab != NULL) delete base_waveform_tab;
	if (morphed_waveform_tab != NULL) delete morphed_waveform_tab;
}
...
*	@return set sample-rate
*/	
int DSP_MorphingSinusOscWTAB::get_sample_rate() { return sample_rate; }
...
*	@return set sample-rate
*/	
float DSP_MorphingSinusOscWTAB::get_fundemental_frequency() { return waveform_fundemental_frequency; }
...
*	@param	segStart start segment
*	@param	segLen	segment length
*	@param	quadrature sine qudrature (enSinQuad: quad_1...4)
*	@return value if done -2 otherwise
*/
float DSP_MorphingSinusOscWTAB::get_sin_segment_value(int index, int seg_start, int seg_len, en_sin_quad quadrature)
{
	float value;
	...
	{
		value =  sin(((float)(index - seg_start) / (float)seg_len) * M_PI_2 + (float)((int)quadrature * M_PI_2));
	}
...
*/
int DSP_MorphingSinusOscWTAB::get_morphing_symetry() { return morphing_symetry; }
...
*/
int DSP_MorphingSinusOscWTAB::calc_wtab(DSP_WaveformTab *wtab, st_segments_length *seg_lens, st_positions *positions)
{
	int i;
...
*	@return void
*/
int DSP_MorphingSinusOsc::get_id() { return id; }
...
*/
int DSP_MorphingSinusOsc::get_pwm_dcycle_set_val() { return pwm_percents_set; }
...
*	@return MSO PWM dutycycle 5-95
*/
int DSP_MorphingSinusOsc::get_pwm_dcycle() { return pwm_percents; }
...
*/
int DSP_MorphingSinusOsc::get_freq_detune_oct() { return detune_octave; }
...
*/
int DSP_MorphingSinusOsc::get_freq_detune_semitones() { return detune_semitones; }
...
*/
int DSP_MorphingSinusOsc::get_freq_detune_cents_set_value() { return detune_cents_set_value; }
...
*/
float DSP_MorphingSinusOsc::get_freq_detune_cents() { return detune_cents; }
...
*/
float DSP_MorphingSinusOsc::get_magnitde() { return magnitude; }
...
*	@return MSO send level to channel 1 0.0-1.0
*/
float DSP_MorphingSinusOsc::get_send_level_1() { return send_level_1; }
...
*	@return MSO send level to channel 2 0.0-1.0
*/
float DSP_MorphingSinusOsc::get_send_level_2() { return send_level_2; }
