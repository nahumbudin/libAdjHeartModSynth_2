...
DSP_KarplusStrong::DSP_KarplusStrong(int Voice, int samp_rate)
{
	...
	pluck_damping_variation = (_KARPLUS_STRONG_MAX_PLUCK_DAMPING_VARIATION + _KARPLUS_STRONG_MIN_PLUCK_DAMPING_VARIATION) / 2.0f;
	character_variation = (_KARPLUS_STRONG_MAX_CHARACTER_VARIATION + _KARPLUS_STRONG_MIN_CHARACTER_VARIATION) / 2.0f;
	magnitude = 0.5f;
	freq = 440.0f;
...
*/
int DSP_KarplusStrong::get_sample_rate() { return sample_rate; }
...
*	@return excitation type _KARPLUS_STRONG_EXCITATION_WHITE_NOISE.... see libAdjHeartModSynth_1.h
*/
int DSP_KarplusStrong::get_excitation_waveform_type() { return excitation_waveform_type; }
...
*/
float DSP_KarplusStrong::get_energy() { return energy; }
...
*/
int DSP_KarplusStrong::get_excitation_waveform_variations() { return excitation_waveform_variations; }
...
*/
float DSP_KarplusStrong::get_pluck_damping() { return pluck_damping; }
...
*			_KARPLUS_STRONG_MIN_PLUCK_DAMPING_VARIATION to _KARPLUS_STRONG_MAX_PLUCK_DAMPING_VARIATION
*/
float DSP_KarplusStrong::get_pluck_damping_variation() { return pluck_damping_variation; }
...
void DSP_KarplusStrong::set_string_damping(int sd)
{
	set_string_damping(_KARPLUS_STRONG_MIN_STRING_DAMPING +
		(float)sd / 100.0f * (float)(_KARPLUS_STRONG_MAX_STRING_DAMPING - _KARPLUS_STRONG_MIN_STRING_DAMPING));
}
...
*			_KARPLUS_STRONG_MIN_STRING_DAMPING to _KARPLUS_STRONG_MAX_STRING_DAMPING
*/
float DSP_KarplusStrong::get_string_damping() { return string_damping; }
...
*			_KARPLUS_STRONG_MIN_STRING_DAMPING_VARIATION to _KARPLUS_STRONG_MAX_STRING_DAMPING_VARIATION
*/
float DSP_KarplusStrong::get_string_damping_variation() { return string_damping_variation; }
...
*			_KARPLUS_STRONG_MIN_CHARACTER_VARIATION to _KARPLUS_STRONG_MAX_CHARACTER_VARIATION
*/
float DSP_KarplusStrong::get_character_variation() { return character_variation; }
...
*/
float DSP_KarplusStrong::get_on_decay() { return on_decay; }
...
*/
float DSP_KarplusStrong::get_off_decay() { return off_decay; }
...
*/
int DSP_KarplusStrong::get_string_dumping_calculation_mode() { return string_dumping_calculation_mode; }
...
*/
float DSP_KarplusStrong::get_amplitude() {return magnitude; }
...
float DSP_KarplusStrong::get_next_decayed_sine_val(int pos)
{
	...
	float out = magnitude * pow(2.0, -active_decay * time) * sin(2.0 * M_PI * freq * time * ((float)excitation_waveform_variations / 150.0f + 1.0f));
