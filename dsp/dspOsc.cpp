	...
	int block_size)
{
	...
	sine_wave = new DSP_SineWaveGenerator(sample_rate, audio_block_size);
...
*/
int DSP_Osc::set_audio_block_size(int size)
{
	if (is_valid_audio_block_size(size))
	{
		...
		if (sine_wave)
		{
			sine_wave->set_audio_block_size(audio_block_size);
		}
...
*   @return buffer size
*/	
int DSP_Osc::get_audio_block_size() {	return audio_block_size; }
...
*/	
int DSP_Osc::init(int samp_rate, int block_size)
{
	int res;
	
	set_sample_rate(samp_rate);
	res = set_audio_block_size(block_size);
	...
	if (sine_wave)
	{
		res != sine_wave->set_audio_block_size(audio_block_size);
	}
...
*	@return OSC waveform
*/
int DSP_Osc::getWaveform() { return waveform; }
...
*	@return OSC PWM dutycycle
*/
int DSP_Osc::get_pwm_dcycle() { return pwm_percents; }
...
*/
int DSP_Osc::get_freq_detune_oct() { return detune_octave; }
...
*/
int DSP_Osc::get_freq_detune_semitones() { return detune_semitones; }
...
*/
int DSP_Osc::get_freq_detune_cents_set_value() { return detune_cents_set_value; }
...
*/
float DSP_Osc::get_freq_detune_cents() { return detune_cents; }
...
*	@return void
*/
void DSP_Osc::set_sync_state(bool snc) { sync_is_on = snc; }
...
*	@return true - sync on
*/
bool DSP_Osc::get_sync_state() { return sync_is_on; }
...
*	@return void
*/
void DSP_Osc::set_track_state(bool trk) { track_is_on = trk; }
...
*	@return true - sync on
*/
bool DSP_Osc::get_track_state(){ return track_is_on; }
...
*/
bool DSP_Osc::getCycle_restarted_sync_state()
{
	bool res = false;
...
*	@return void
*/
void DSP_Osc::enable_unison_square() { sine_wave->enable_unison_square(); }
...
*	@return void
*/
void DSP_Osc::disable_unison_square() { sine_wave->disable_unison_square(); }

bool DSP_Osc::get_unison_square_state() { return sine_wave->get_unison_square_state(); }
...
float DSP_Osc::set_harmonies_detune(int det)
{
	return set_harmonies_detune((float)_MIN_HARMONIES_DETUNE_FACTOR + 
		(float)(_MAX_HARMONIES_DETUNE_FACTOR - _MIN_HARMONIES_DETUNE_FACTOR) *(float)det / 100.0f);
}
...
*/
float DSP_Osc::get_harmonies_detune() { return harmonies_detune_factor; }
...
float DSP_Osc::set_harmonies_distortion(int dis)
{
	return set_harmonies_distortion((float)_MIN_HARMONIES_DISTORTION_FACTOR + 
				(float)(_MAX_HARMONIES_DISTORTION_FACTOR - _MIN_HARMONIES_DISTORTION_FACTOR) *(float)dis / 100.0f);
}
...
*/
float DSP_Osc::get_harmonies_distortion() { return harmonies_dist_factor; }
...
*	@return unison mode
*/
int DSP_Osc::get_unison_mode() { return unison_mode; }
...
*/
float DSP_Osc::get_magnitde() { return magnitude; }
...
*	@return void
*/
void DSP_Osc::set_fix_tone_state(bool fix) { fix_tone_is_on = fix; }
...
*/
bool DSP_Osc::get_fix_tone_state() { return fix_tone_is_on; }
...
*/
float DSP_Osc::get_send_level_1() { return send_level_1; }
...
*/
float DSP_Osc::get_send_level_2() { return send_level_2; }
