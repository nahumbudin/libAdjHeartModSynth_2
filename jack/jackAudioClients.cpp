...
*	History:\n
*		11 - Nov - 2019\n
*		version	1.0(revised version from old libAdjHeartRaspiFlSynthMultiCore_3_1 October 18, 2017)
*		
*		17 - May - 2020
*		version	1.1 (define output client - output AdjSynth signal, and input client to enable signal\n
...
//jack_port_t *inputMidiPort[_MAX_NUM_OF_MIDI_IN_PORTS] = { NULL };
