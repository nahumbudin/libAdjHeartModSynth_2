...
*   @return void
*/
void MidiStream::initialize_midiStream_memory(midi_stream_mssg_block_t *data, unsigned int num)
{
	unsigned int i;
...
*   @return void
*/
void MidiStream::initialize_rawdataMssgs_memory(raw_data_mssg_block_t *data, unsigned int num)
{
	unsigned int i;
