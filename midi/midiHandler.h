...
#ifndef _MIDI_HANDLER
#define _MIDI_HANDLER
...
public:
	...
	void connect_midi_stream();
	void disconnect_midi_stream();
	
//	void setActiveInput(int in);
		
	virtual void update(void);
		
	inline void register_callback_note_off(void(*fptr)(uint8_t channel, uint8_t note));		
	...
	inline void register_callback_change_program(void (*fptr)(uint8_t channel, uint8_t program));		
	...
	inline void register_callback_sysex_mssg(void(*fptr)(uint8_t *msg, uint8_t length));
