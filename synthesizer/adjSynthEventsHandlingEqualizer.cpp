...
*   @return 0
*/
int AdjSynth::band_equilizer_event(int beqid, int eventid, int val, _setting_params_t *params)
{
...
int AdjSynth::band_equilizer_event_bool(int beqid, int eventid, bool val, _setting_params_t *params)
{
	return 0;
}
