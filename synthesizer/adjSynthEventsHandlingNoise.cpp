...
*   @return void
*/
int AdjSynth::noise_event(int noiseid, int eventid, int val, _setting_params_t *params, int program)
{
	switch (eventid)
	{
		case _NOISE_COLOR:
...
int AdjSynth::noise_event_bool(int noiseid, int eventid, bool val, _setting_params_t *params, int program)
{
	switch (eventid)
	{
	case _NOISE_ENABLE:
