...
int AdjSynth::reverb_event(int revid, int eventid, int val, _setting_params_t *params)
{
	int voice;
...
int AdjSynth::reverb_event_bool(int revid, int eventid, bool val, _setting_params_t *params)
{
	//	int voice;
		switch(eventid)
	{
