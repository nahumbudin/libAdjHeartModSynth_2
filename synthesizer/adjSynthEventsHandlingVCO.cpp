...
*   @return 0 is done.
*/
int AdjSynth::vco_event(int vcoid, int eventid, int val, _setting_params_t *params, int program)
{
	...
	mod_synth_settings_int_param_t _int_param;
		...
		case _OSC_HAMMOND_PERCUSION_MODE:
			if (voice == 0)
			{
				adj_synth_settings_manager->set_int_param_value
						...
						val, _SET_VALUE); // No action, just set value.
...
*   @return void
*/
int AdjSynth::vco_event_bool(int vcoid, int eventid, bool val, _setting_params_t *params, int program)
{
