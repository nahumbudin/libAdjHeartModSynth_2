...
public:
	...
	static FluidSynthInterface *create_instance(ModSynthSettings *glob_settings,
	...
	fluid_res_t load_and_set_fluid_synth_soundfont(string path);
	...
	int get_fluid_synth_sound_font_presets(int sfnum, std::vector<_soundfont_presets_data_t> *presets);
	int get_fluid_synth_loaded_sound_fonts_presets(std::vector<_soundfont_presets_data_t> *presets);
	...
	std::map<std::string, int> loaded_soundfont_map;
  ...
  private:
	...
	ModSynthSettings *global_settings;
