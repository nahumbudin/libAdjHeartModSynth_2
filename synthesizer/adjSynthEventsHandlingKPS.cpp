...
*   @return void
*/
int AdjSynth::karplus_event(int karlplusid, int eventid, int val, _setting_params_t *params, int program)
{
	switch (karlplusid)
	{
...
int AdjSynth::karplus_event_bool(int karplusid, int eventid, bool val, _setting_params_t *params, int program)
{
	switch (karplusid)
	{
		case _KARPLUS_1_EVENT:
