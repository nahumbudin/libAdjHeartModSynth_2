...
int AdjSynth::audio_event_int(int audid, int eventid, int val, _setting_params_t *params, int program)
{
...
*	@param int prog program num: n/a
*/
int AdjSynth::audio_event_bool(int audid, int eventid, bool val, _setting_params_t *params, int program)
{
	if (audid == _AUDIO_EVENT_1)
	{
		switch (eventid)
