...
*   @return 0
*/
int AdjSynth::distortion_event(int distid, int eventid, int val, _setting_params_t *params, int program)
{
	int voice;
	float value;
...
*   @return 0
*/
int AdjSynth::distortion_event_bool(int distid, int eventid, bool val, _setting_params_t *params, int program)
{
	switch (eventid)
	{
