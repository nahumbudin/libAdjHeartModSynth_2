...
*	@return set sample-rate
*/	
int SynthPADcreator::get_sample_rate() { return sample_rate; }
...
*/
float SynthPADcreator::get_base_harmony_width() { return base_harmony_bandwidth; }
...
int SynthPADcreator::get_harmony_shape() { return harmony_shape; }
...
*/
int SynthPADcreator::get_harmony_shape_cutoff() { return harmony_shape_cutoff; }
...
*/
float SynthPADcreator::get_harmonies_detune() { return harmonies_detune; }
...
*/
int SynthPADcreator::get_base_note() { return base_note; }
...
*/
float SynthPADcreator::get_base_frequency() { return base_frequency; }
...
* @return	profile size.
*/
int SynthPADcreator::get_profile_size() { return profile_size; }
...
*/
float *SynthPADcreator::get_profile_data() { 	return &profile[0]; }
...
*/
int SynthPADcreator::get_spectrum_size() { return spectrum_length; }
...
*/
float *SynthPADcreator::get_spectrum_data() { return &spectrum[0]; }
