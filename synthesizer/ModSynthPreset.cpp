...
int ModSynthPresets::set_synth_settings(mod_synth_preset_t *preset) 
{
	...
	for (int chan = 0; chan < 16; chan++)
	{
		...
		if (valid_setting)
		{		
			ModSynth::get_instance()->get_adj_synth()->midi_mixer_event(
					_MIDI_MIXER_1_EVENT,
					_MIXER_CHAN_1_LEVEL + chan, 
					preset->chennels_presets[chan].mixer_presets.channel_level,
					ModSynth::get_instance()->get_adj_synth()->get_active_settings_params());

			ModSynth::get_instance()->get_adj_synth()->midi_mixer_event(_MIDI_MIXER_1_EVENT,
	...
	if (valid_setting)
	{
		...
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_enabled_value(preset->fluid_preset.reverb_enabled);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_damp_value(preset->fluid_preset.reverb_damp);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_level_value(preset->fluid_preset.reverb_level);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_room_size_value(preset->fluid_preset.reverb_room);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_width_value(preset->fluid_preset.reverb_width);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_reverb_params();
				
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_enabled_value(preset->fluid_preset.chorus_enabled);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_depth_value(preset->fluid_preset.chorus_depth);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_level_value(preset->fluid_preset.chorus_level);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_N_value(preset->fluid_preset.chorus_n);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_speed_value(preset->fluid_preset.chorus_speed);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_waveform_value(preset->fluid_preset.chorus_waveform);
		ModSynth::get_instance()->get_fluid_synth()->set_fluid_synth_chorus_params();
				
		ModSynth::get_instance()->get_adj_synth()->band_equilizer_event(
