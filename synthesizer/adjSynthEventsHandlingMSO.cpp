...
*   @return void
*/
int AdjSynth::mso_event(int msoid, int eventid, int val, _setting_params_t *params, int program)
{
...
int AdjSynth::mso_event_bool(int msoid, int eventid, bool val, _setting_params_t *params, int program)
{
	switch (msoid)
	{
	case _MSO_1_EVENT:
