...
#ifndef _ADJ_SYNTHESIZER
#define _ADJ_SYNTHESIZER
...
#include "../audio/audioPoliphonyMixer.h"
...
int set_patch_settings_default_params_callback_wrapper(_setting_params_t *params, int prog);
...
public:
	...
	int init_synth_settings_params(_setting_params_t *settings_params);
	...
	int set_settings_params(ModSynthSettings *settings,  
		_setting_params_t *settings_params);

	std::string get_program_patch_name(int prog);
	
	_setting_params_t *get_active_patch_params();
	_setting_params_t *get_active_settings_params();
	...
	int set_default_patch_parameters(_setting_params_t *params, int prog);
	int set_default_patch_parameters_vco(_setting_params_t *params, int prog);
	int set_default_patch_parameters_noise(_setting_params_t *params, int prog);
	int set_default_patch_parameters_kps(_setting_params_t *params, int prog);
	int set_default_patch_parameters_mso(_setting_params_t *params, int prog);
	int set_default_patch_parameters_pad(_setting_params_t *params, int prog);
	int set_default_patch_parameters_filter(_setting_params_t *params, int prog);
	int set_default_patch_parameters_amp(_setting_params_t *params, int prog);
	int set_default_patch_parameters_distortion(_setting_params_t *params, int prog);
	int set_default_patch_parameters_modulators(_setting_params_t *params, int prog);		
	
	int set_default_settings_parameters(_setting_params_t *params);
	int set_default_settings_parameters_equalizer(_setting_params_t *params);
	int set_default_settings_parameters_reverb(_setting_params_t *params);
	int set_default_settings_parameters_mixer(_setting_params_t *params);
	int set_default_settings_parameters_keyboard(_setting_params_t *params);
	...
	void set_hammond_percusion_mode(int mod, _setting_params_t *params, int program);
		
	int vco_event(int vcoid, int eventid, int val, _setting_params_t *params, int program);
	int vco_event_bool(int vcoid, int eventid, bool val, _setting_params_t *params, int program);
	int noise_event(int noiseid, int eventid, int val, _setting_params_t *params, int program);
	int noise_event_bool(int noiseid, int eventid, bool val, _setting_params_t *params, int program);
	int karplus_event(int karlplusid, int eventid, int val, _setting_params_t *params, int program);
	int karplus_event_bool(int karlplusid, int eventid, bool val, _setting_params_t *params, int program);
	int mso_event(int msoid, int eventid, int val, _setting_params_t *params, int program);
	int mso_event_bool(int msoid, int eventid, bool val, _setting_params_t *params, int program);
	int pad_event(int padid, int eventid, int val, _setting_params_t *params, int program);
	int pad_event_bool(int padid, int eventid, bool val, _setting_params_t *params, int program);
	int filter_event(int filtid, int eventid, int val, _setting_params_t *params, int program);
	int audio_event_int(int audid, int eventid, int val, _setting_params_t *params, int program);
	int audio_event_bool(int audid, int eventid, bool val, _setting_params_t *params, int program);
	int amp_event(int ampid, int eventid, int val, _setting_params_t *params, int program);
	int distortion_event(int distid, int eventid, int val, _setting_params_t *params, int program);
	int distortion_event_bool(int distid, int eventid, bool val, _setting_params_t *params, int program);
	int modulator_event(int modid, int eventid, int val, _setting_params_t *params, int program);
	
	int reverb_event(int revid, int eventid, int val, _setting_params_t *params);
	int reverb_event_bool(int revid, int eventid, bool val, _setting_params_t *params);
	int band_equilizer_event(int beqid, int eventid, int val, _setting_params_t *params);
	int band_equilizer_event_bool(int beqid, int eventid, bool val, _setting_params_t *params);	
	int midi_mixer_event(int mixid, int eventid, int val, _setting_params_t *params);	
	int kbd_event(int kbid, int eventid, int val, _setting_params_t *params);
	int kbd_event_bool(int kbid, int eventid, bool val, _setting_params_t *params);
	int midi_mode_event(int midmodid, int eventid, int val, _setting_params_t *params);
	int play_mode_event_bool(int pmodid, int eventid, bool val, _setting_params_t *params);
	...
	SynthProgram *synth_program[_SYNTH_NUM_OF_PROGRAMS];
	...
	ModSynthSettings *adj_synth_settings_manager = NULL;
...
private:
	...
	_setting_params_t active_adj_synth_patch_params;
	/* Holds the AdjSynth settings parameters */
	_setting_params_t active_adj_synth_settings_params;
