...
#ifndef _ADJ_SYNTH_PRESET
#define _ADJ_SYNTH_PRESET
...
public:
	...
	static string *get_synth_preset_summary_text(int presetNum);
...
private:
	...
	static string preset_summary_text[_NUM_OF_PRESETS];
