...
*   @return void
*/
int AdjSynth::pad_event(int padid, int eventid, int val, _setting_params_t *params, int program)
{
	int value = val;
...
int AdjSynth::pad_event_bool(int padid, int eventid, bool val, _setting_params_t *params, int program)
{
